...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("\nStudenti aranjati alfabetic dupa grupa:");
        ...
        System.out.println("\nStudenti aranjati dupa medie descrescator:");
        students.sort(Comparator.comparing(Student::getMedie).reversed());
        for(Student student : students) {
            System.out.println(student.getNume_Prenume() + " " + student.getGrupa() + " " + Arrays.toString(student.getNota()));
        }
        System.out.println("\nStudenti aranjati crescator dupa numarul de restante:");
